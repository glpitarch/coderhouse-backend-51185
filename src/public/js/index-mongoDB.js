...
socket.on('productsList', products => {
    ...
    for (const product of products) {
        ...
        document.getElementById('productContainer').innerHTML += `
            <div id="productCardId${_id}" class="pad-3">
                <p><strong>Nombre: </strong><span id="titleProductId${_id}"></span></p>
                <p><strong>Categoria: </strong><span id="categoryProductId${_id}"></span></p>
                <p><strong>Descripción: </strong><span id="descriptionProductId${_id}"></span></p>
